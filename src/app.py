#!/usr/bin/env python3
"""Bilibili UP Monitor - Desktop Application.

Launches the Flask dashboard inside a native window using pywebview.
Built-in terminal panel for logs. No external CMD window.
"""
